...
def return_snowflake_conn():
    ...
    conn = snowflake.connector.connect(account = 'JAQVJUH-UQB27541',warehouse = 'HW6_WH',  database = 'HW6_DB', user = 'connorjfq', password = 'Nortonbobjoe-lumos124', role = 'ACCOUNTADMIN')
    return conn.cursor()
...
with DAG(
    ...
    target_table = "HW6_DB.RAW_DATA.STOCK_PRICE"
    symbol = "AAPL"
